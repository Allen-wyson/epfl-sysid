...
Figure~\ref{fig:autocorr} shows the autocorrelation function of two different types of signals. On the left hand side (Figure~\ref{fig:autocorrPRBS}) there is a PRBS signal (length of the shift register is 4 and number of periods is 2) and its corresponding autocorrelation function. In addition, the figure on the right hand side (Figure~\ref{fig:autocorrSINUS}) displays a sinusiodal signal and its autocorrelation function.  
...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Two signals and their corresponding autocorrelation}\label{fig:autocorr}
\end{figure}
