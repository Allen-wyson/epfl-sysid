...
The Box-Jenkins structure has again a noise model, but does share the denominator of the noise transfer function with the denominator of the plant transfer function.
