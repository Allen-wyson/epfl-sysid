...
\begin{figure}[h]
	...
	\begin{subfigure}{\textwidth}
		...
		\subcaption{Comparison of the simulated output and the predicted output. The simulated output is shown for the model parametrized by the parameters identified using the plain ARX method and the IV method, respectively.}
